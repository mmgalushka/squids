...
#     train_file = pathlib.Path(output_dir / "train.json")
#     val_file = pathlib.Path(output_dir / "val.json")
#     test_file = pathlib.Path(output_dir / "test.json")
